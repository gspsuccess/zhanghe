$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/project/delete');
            });

            $('a.edit').click(function(){
                var id = $(this).attr('data-id');
                edit(id,['name','remark','id'],'/index/project/edit');
            })
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/project/edit':'/index/project/add';
            $.ajax({
                url: url,
