$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/massif/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/massif/delete');
            });

            $('a.edit').click(function(){
                var id = $(this).attr('data-id');
                edit(id,['project_id','name','serialno','remark','id'],'/index/massif/edit');
            });

            $('a.flag').click(function(){
                var id = $(this).attr('data-id');
                flag(id,'/index/massif/flag');
            })
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/massif/edit':'/index/massif/add';
            $.ajax({
                url: url,
