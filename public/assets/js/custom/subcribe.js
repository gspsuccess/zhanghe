$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/subcribe/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/subcribe/delete');
            });

            $('a.edit').click(function(){
                var id = $(this).attr('data-id');

                edit(id,['project_id','massif_id','realname','phone','id'],'/index/subcribe/edit');
            });

            $('a.flag').click(function(){
                var id = $(this).attr('data-id');
                flag(id,'/index/subcribe/flag');
            });
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/subcribe/edit':'/index/subcribe/add';
            $.ajax({
                url: url,
