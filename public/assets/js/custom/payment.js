$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/payment/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/payment/delete');
            });

            $('a.edit').click(function(){
                var id = $(this).attr('data-id');
                edit(id,['name','appid','appsecret','remark','id'],'/index/payment/edit');
            })
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/payment/edit':'/index/payment/add';
            $.ajax({
                url: url,
