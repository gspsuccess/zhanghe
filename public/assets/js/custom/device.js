$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/device/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.edit').click(function(){
                ...
                edit(id,['project_id','massif_id','name','serialno','lat','lng','address','id'],'/index/device/edit');
            });

            $('a.flag').click(function(){
                var id = $(this).attr('data-id');
                flag(id,'/index/device/flag');
            })
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/device/edit':'/index/device/add';
            $.ajax({
                url: url,
