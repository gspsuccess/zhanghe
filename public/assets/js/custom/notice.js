$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/notice/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/notice/delete');
            });
            ...
            $('a.edit').click(function(){
                ...
                edit(id,['project_id','massif_id','title','starttime','endtime','content','id'],'/index/notice/edit');
            });

            $('a.flag').click(function(){
                var id = $(this).attr('data-id');
                flag(id,'/index/notice/flag');
            })
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/notice/edit':'/index/notice/add';
            $.ajax({
                url: url,
