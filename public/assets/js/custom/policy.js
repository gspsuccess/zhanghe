$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/policy/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/policy/delete');
            });

            $('a.edit').click(function(){
                var id = $(this).attr('data-id');

                edit(id,['title','source','content','id'],'/index/policy/edit');
            });
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/policy/edit':'/index/policy/add';
            $.ajax({
                url: url,
