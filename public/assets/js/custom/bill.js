$(function () {
    $("#table").bootstrapTable({ // 对应table标签的id
        url: "/index/bill/index", // 获取表格数据的url
        method: 'post',
        ...
        onLoadSuccess: function () {  //加载成功时执行
            ...
            $('a.remove').click(function(){
                ...
                var data = {id:id};
                remove(data,'/index/bill/delete');
            });

            $('a.edit').click(function(){
                var id = $(this).attr('data-id');

                edit(id,['title','amount','contacts','phone','address','remark','id'],'/index/bill/edit');
            });

            $('a.flag').click(function(){
                var id = $(this).attr('data-id');
                flag(id,'/index/bill/flag');
            })
        },
    ...
    $("#submitBtn").click(function () {
        ...
        bv.validate();
        if (bv.isValid()) {
            var url = $('#id').val()?'/index/bill/edit':'/index/bill/add';
            $.ajax({
                url: url,
